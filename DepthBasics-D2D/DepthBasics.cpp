...
bool CDepthBasics::SetStatusMessage(WCHAR* szMessage, DWORD nShowTimeMsec, bool bForce)
{
...
/// </returns>
HRESULT CDepthBasics::GetScreenshotFileName(LPWSTR lpszFilePath, UINT nFilePathSize)
{
